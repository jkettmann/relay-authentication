...
export const posts = [
  ...
  new Post({
    id: '3',
    creatorId: '1',
    title: 'Ein Schiff zum Entspannen und Feiern',
    image: schiff,
    description: 'description',
  }),
  new Post({
    id: '4',
    creatorId: '1',
    title: 'Ein schöner Platz am Meer',
    image: meer,
    description: 'description',
  }),
  new Post({
  ...
  new Post({
    id: '6',
    creatorId: '2',
    title: 'Mediteran anmutende Finka',
    image: finka,
    description: 'description',
  }),
  new Post({
  ...
  new Post({
    id: '9',
    creatorId: '1',
    title: 'Möglichkeit zur schönen Aussentrauung',
    image: aussentrauung,
    description: 'description',
  }),
]
